...
__all__ = [
    'ISpSerializeState', 'DISPID_SPRsItem', 'SVSFIsXML',
    'SAFT24kHz8BitStereo', 'SPXRO_Alternates_SML',
    'SAFT44kHz16BitStereo', 'DISPID_SOTsCount', 'IEnumSpObjectTokens',
    'eLEXTYPE_APP', 'SFTSREngine', 'DISPID_SVAudioOutputStream',
    'eLEXTYPE_PRIVATE16', 'DISPID_SLWsCount', 'SPCT_SUB_DICTATION',
    'SRARoot', 'DISPID_SMSGetData', 'SVPNormal',
    'DISPID_SRCERecognition', 'DISPID_SPPNumberOfElements',
    'SP_VISEME_0', 'SPXMLRESULTOPTIONS', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SOTMatchesAttributes', 'SPWORDLIST', 'SP_VISEME_18',
    'DISPID_SPPValue', 'SPAUDIOSTATE', 'SP_VISEME_2', 'DISPID_SOTCId',
    'SP_VISEME_20', 'ISpeechRecoContext', 'SPSNotOverriden',
    'DISPID_SDKSetStringValue', 'SAFT22kHz8BitStereo',
    'SpeechRecognitionType', 'ISpNotifySource', 'ISpeechLexiconWords',
    'DISPID_SPIGrammarId', 'DISPID_SpeechRecoContextEvents',
    'SECHighConfidence', 'SPEVENTSOURCEINFO',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRSNumberOfActiveRules', 'SpeechRetainedAudioOptions',
    'DISPID_SRGState', 'eLEXTYPE_PRIVATE17', 'SVP_17',
    'DISPID_SPRsCount', 'ISpeechRecoResultTimes',
    'DISPID_SpeechGrammarRuleStateTransition', 'eLEXTYPE_RESERVED8',
    'SVPOver', 'SpCompressedLexicon', 'SPEI_SOUND_START',
    'DISPID_SPEs_NewEnum', 'SpStreamFormatConverter',
    'DISPID_SVVoice', 'ISpPhraseAlt', 'DISPID_SRRSaveToMemory',
    'SPSEMANTICFORMAT', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPEI_INTERFERENCE', 'SREBookmark', 'SPRST_ACTIVE',
    'DISPID_SDKGetStringValue', 'DISPID_SWFESamplesPerSec',
    'SPEI_SENTENCE_BOUNDARY', 'SPEI_TTS_AUDIO_LEVEL', 'SRSEDone',
    'DISPID_SpeechBaseStream', 'ISpeechAudioBufferInfo',
    'SPSHT_EMAIL', 'DISPID_SRCESoundEnd', 'SPPHRASEELEMENT',
    'DISPID_SRCBookmark', 'DISPID_SRRAudioFormat',
    'SPAO_RETAIN_AUDIO', 'SPWF_INPUT', 'SPWAVEFORMATTYPE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPWORDPRONOUNCEABLE',
    'SDA_No_Trailing_Space', 'SPEI_RESERVED6', 'DISPID_SFSOpen',
    'DISPID_SpeechLexiconWords', 'DISPID_SMSAMMHandle',
    'DISPID_SRCEFalseRecognition', 'SPWT_LEXICAL',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SLWWord',
    'DISPID_SGRSTRule', 'SPGS_ENABLED', 'eLEXTYPE_VENDORLEXICON',
    'ISpRecognizer', 'DISPID_SOTSetId', 'ISpRecoResult',
    'DISPID_SVSCurrentStreamNumber', 'SAFTCCITT_uLaw_22kHzStereo',
    'SVSFIsFilename', 'SPPS_RESERVED2', 'SPAUDIOBUFFERINFO',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SOTCGetDataKey',
    'DISPID_SGRSTNextState', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPRuleConfidence', 'SWTDeleted',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRCResume',
    'DISPID_SpeechVoiceStatus', 'SPWORDPRONUNCIATION',
    'eLEXTYPE_RESERVED10', 'DISPID_SGRsCount', 'SVSFDefault',
    'SRERecoOtherContext', 'SPBINARYGRAMMAR', 'ISpPhoneConverter',
    'DISPID_SpeechPhraseProperties', 'SFTInput', 'SITooFast',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SLPType',
    'SAFT11kHz16BitStereo', 'SpeechWordType',
    'DISPID_SVAlertBoundary', 'DISPID_SpeechLexicon',
    'DISPID_SRAudioInputStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPILanguageId',
    'eWORDTYPE_ADDED', 'SPDKL_CurrentConfig',
    'SpeechPropertyHighConfidenceThreshold', 'SPPHRASEPROPERTY',
    'SPEI_VISEME', 'ISpeechWaveFormatEx', 'SPCS_ENABLED',
    'STSF_CommonAppData', 'SSSPTRelativeToCurrentPosition',
    'SPEVENTENUM', 'SAFT48kHz16BitMono', 'SAFTCCITT_ALaw_8kHzStereo',
    'SVSFParseSapi', 'SPINTERFERENCE_NOISE', 'SPVISEMES',
    'DISPID_SLGetWords',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVP_10',
    'SVSFParseMask', 'SpeechCategoryRecognizers', 'DISPID_SPRuleName',
    'SpeechEngineProperties', 'SP_VISEME_8', 'SVP_0', 'SSTTWildcard',
    'SRADefaultToActive', 'SPEI_ADAPTATION', 'eLEXTYPE_PRIVATE1',
    ...
    'ISpVoice', 'DISPID_SVSLastBookmark',
    'DISPID_SRCSetAdaptationData', 'ISpShortcut',
    'SpObjectTokenCategory', 'SpeechVoiceEvents', 'DISPID_SBSWrite',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SGRSTWeight',
    'SECFEmulateResult', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechAudio',
    'DISPID_SVEBookmark', 'SpeechTokenShellFolder',
    ...
    'DISPID_SpeechAudio', 'SPEI_PHRASE_START', 'SPLEXICONTYPE',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRCState',
    'DISPID_SVEEnginePrivate', 'DISPID_SRIsUISupported',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SGRsItem',
    'DISPID_SRRTimes', 'SpeechRecoProfileProperties', 'SVEAudioLevel',
    'SPEI_MIN_TTS', 'SVESentenceBoundary', 'DISPID_SLWType',
    'DISPID_SPPChildren', 'DISPID_SPEAudioTimeOffset',
    'SPEI_SOUND_END', 'SGDSActive', 'SpeechDictationTopicSpelling',
    'ISpeechResourceLoader', 'IInternetSecurityManager',
    'SVSFIsNotXML', 'SPEI_MAX_SR', 'SAFT32kHz8BitMono',
    '_ISpeechVoiceEvents', 'DISPID_SVGetAudioOutputs', 'SBOPause',
    'DISPID_SRGId', 'DISPID_SRGSetWordSequenceData',
    'eLEXTYPE_PRIVATE14', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechRecognizer', 'SVP_16', 'SpeechEngineConfidence',
    'SPPS_Verb', 'SAFT32kHz8BitStereo', 'SpeechTokenContext',
    'eLEXTYPE_PRIVATE11', 'SPGRAMMARSTATE',
    'SWPUnknownWordUnpronounceable', 'SP_VISEME_7',
    'DISPID_SLPs_NewEnum', 'DISPID_SGRSTText', 'SGSExclusive',
    'ISpeechGrammarRuleStateTransitions', 'SAFTADPCM_44kHzStereo',
    'eLEXTYPE_PRIVATE18', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SABufferInfo', 'ISpeechPhraseElement',
    'DISPID_SMSSetData', 'SPADAPTATIONRELEVANCE', 'SVSFPersistXML',
    'SpeechTokenIdUserLexicon', 'DISPID_SRAudioInput',
    'SpUnCompressedLexicon', 'eLEXTYPE_RESERVED4',
    'DISPID_SPIReplacements', 'DISPID_SASNonBlockingIO',
    'DISPID_SWFEAvgBytesPerSec', 'SPFM_CREATE', 'SPFM_NUM_MODES',
    'DISPID_SGRSAddRuleTransition', 'SPBO_NONE',
    'DISPID_SRRAlternates', 'DISPID_SRGSetTextSelection',
    'SRTExtendableParse', 'SAFT8kHz8BitMono', 'DISPID_SFSClose',
    'SVSFNLPMask', 'SPEI_SR_BOOKMARK', 'SpeechCategoryAppLexicons',
    'SpeechGrammarWordType', 'DISPID_SPRDisplayAttributes',
    'SAFT11kHz8BitMono', 'ISpPhoneticAlphabetSelection',
    'DISPID_SAStatus', 'DISPID_SASetState', 'SPWORDPRONUNCIATIONLIST',
    'SPSUnknown', 'SDA_One_Trailing_Space', 'SAFTGSM610_22kHzMono',
    'SPSTREAMFORMATTYPE', 'STCRemoteServer',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRRSpeakAudio',
    'SPEI_RESERVED2', 'SPAR_Medium', 'SRSInactive',
    'SPSHORTCUTPAIRLIST', 'SRCS_Disabled', 'eLEXTYPE_PRIVATE3',
    'SpeechUserTraining', 'SSSPTRelativeToStart',
    'DISPID_SRGDictationLoad', 'SP_VISEME_3', 'SPSFunction',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPCIdToPhone', 'SRAORetainAudio', 'SAFTADPCM_44kHzMono',
    'SWPUnknownWordPronounceable', 'DISPID_SVEStreamStart',
    'SP_VISEME_6', 'eLEXTYPE_PRIVATE19', 'SVP_15',
    'DISPID_SpeechRecognizerStatus', 'SVP_12', 'SpeechAddRemoveWord',
    'DISPID_SAFSetWaveFormatEx', '_RemotableHandle',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SGRsCommitAndSave',
    'SRSEIsSpeaking', 'SPPHRASE', 'SAFT44kHz8BitMono',
    'SPDATAKEYLOCATION', 'DISPID_SRGRecoContext', 'DISPID_SVSkip',
    'DISPID_SpeechMMSysAudio', 'SPPHRASEREPLACEMENT', 'SpFileStream',
    'SPEI_RECO_STATE_CHANGE', 'SDKLCurrentUser',
    'DISPID_SWFEFormatTag', 'SSFMOpenReadWrite',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SLPLangId', 'SVPAlert',
    'SPEI_REQUEST_UI', 'SpeechRecoContextState',
    'DISPID_SpeechPhraseAlternate', 'SAFT8kHz16BitStereo',
    'SpInprocRecognizer', 'SGRSTTDictation', 'tagSTATSTG',
    'DISPID_SBSRead', 'SPDKL_LocalMachine', 'SP_VISEME_19',
    'SREAllEvents', 'SREStreamStart', 'SPSHT_NotOverriden',
    'DISPID_SPELexicalForm', 'SPCATEGORYTYPE', 'DISPID_SAVolume',
    'DISPID_SOTsItem', 'SPPS_Interjection', 'SREPhraseStart',
    'DISPID_SRGetRecognizers', 'tagSPTEXTSELECTIONINFO',
    'SpeechVisemeType', 'SLODynamic', 'SPBO_AHEAD', 'SPRULESTATE',
    'SPEI_TTS_PRIVATE', 'SPSLMA', 'SPSERIALIZEDPHRASE',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SLRemovePronunciation',
    'SpeechLoadOption', 'ISpeechPhraseAlternate',
    'DISPID_SVAudioOutput', 'DISPID_SVSLastResult', 'SVSFParseSsml',
    'SP_VISEME_9', 'DISPID_SRCEBookmark', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SPANumberOfElementsInResult', 'SpSharedRecoContext',
    'SASRun', 'Speech_Max_Pron_Length', 'DISPID_SGRSTType',
    'SpSharedRecognizer', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SASCurrentDevicePosition', 'eLEXTYPE_PRIVATE7',
    'ISpAudio', 'DISPID_SCSBaseStream', 'DISPID_SBSSeek',
    'SAFT12kHz8BitStereo', 'SECFIgnoreWidth', 'DISPID_SGRsCommit',
    'eWORDTYPE_DELETED', 'SAFT24kHz16BitMono', 'SVSFVoiceMask',
    'DISPID_SRRTOffsetFromStart', 'eLEXTYPE_PRIVATE13',
    'SpAudioFormat', 'DISPID_SpeechCustomStream', 'SPEI_MAX_TTS',
    'SPPHRASERULE', 'SVP_5', 'eLEXTYPE_PRIVATE5', 'SP_VISEME_21',
    'DISPID_SOTs_NewEnum', 'SpeechFormatType', 'DISPIDSPTSI',
    'SpeechGrammarState', 'DISPID_SGRSTPropertyValue',
    'SVEWordBoundary', 'eLEXTYPE_RESERVED9', 'SVP_3',
    'DISPID_SRCEEndStream', 'SVSFlagsAsync', 'SPRS_ACTIVE',
    'SAFT44kHz16BitMono', 'SPAS_STOP', 'DISPID_SGRsFindRule',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPPId',
    'DISPID_SLPSymbolic', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_PRIVATE10', 'SAFT32kHz16BitMono',
    'DISPID_SRCRetainedAudioFormat', 'SAFT11kHz16BitMono',
    'SPPS_SuppressWord', 'ISpeechAudioStatus', 'SSFMCreateForWrite',
    'SPFM_CREATE_ALWAYS', 'DISPID_SADefaultFormat', 'SAFTText',
    'DISPID_SGRAddState', 'DISPID_SOTIsUISupported',
    'DISPIDSPTSI_SelectionLength', 'SpeechLexiconType',
    'DISPID_SpeechObjectToken', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRCEStartStream', 'SpeechDisplayAttributes',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpRecognizer2', 'DISPID_SWFEBlockAlign',
    'DISPID_SPEActualConfidence', 'SRTAutopause',
    'SPINTERFERENCE_TOOLOUD', 'SVEAllEvents', 'SpeechAudioFormatType',
    'SREStateChange', 'SP_VISEME_14', 'SAFT32kHz16BitStereo',
    'SpeechGrammarRuleStateTransitionType',
    'SpeechEmulationCompareFlags', 'SAFTGSM610_44kHzMono',
    'SAFT22kHz16BitStereo', 'SP_VISEME_5', 'SDKLDefaultLocation',
    'SVP_21', 'SDTPronunciation', 'SVP_13', 'SpCustomStream',
    'DISPID_SPPEngineConfidence', 'SPWORD', 'SPLO_DYNAMIC',
    ...
    'ISpeechObjectTokenCategory', 'DISPID_SRRRecoContext',
    'SPSHORTCUTTYPE', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SpeechAudioFormat', 'SAFTNonStandardFormat',
    'SpNotifyTranslator', 'SVP_11', 'ISpeechTextSelectionInformation',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechGrammarRule',
    'ISpGrammarBuilder', 'ISpRecoGrammar2', 'DISPID_SVPause',
    'SPEVENT', 'SpMMAudioIn', 'SPPROPERTYINFO', 'ISpStreamFormat',
    'SpeechWordPronounceable', 'Speech_StreamPos_Asap',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPAsCount',
    'DISPID_SOTGetAttribute', 'SpeechStreamFileMode',
    'ISpRecoContext2', 'SPAUDIOSTATUS', 'DISPID_SPPsCount',
    'DISPID_SRRecognizer', 'DISPID_SLPsItem', 'SpeechRunState',
    'SpeechCategoryPhoneConverters', 'DISPID_SRGCmdLoadFromObject',
    'SPEI_UNDEFINED', 'SP_VISEME_1', 'SPFM_OPEN_READWRITE',
    'DISPID_SLWPronunciations', 'SAFTADPCM_8kHzStereo',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SpeechPhraseRule',
    'DISPID_SPEAudioStreamOffset', 'SITooLoud', 'ISpeechMemoryStream',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SOTCreateInstance',
    'DISPID_SOTCategory', 'DISPID_SPPsItem', 'SVP_18',
    'DISPID_SRCRecognizer', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SGRsDynamic', 'SLTApp', 'SAFTADPCM_11kHzStereo',
    'DISPID_SPRulesItem', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechPhraseRules', 'SPXRO_SML',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVF_Stressed',
    'SECFIgnoreKanaType', 'DISPID_SPEsCount',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechRecoResult2',
    'DISPID_SVSyncronousSpeakTimeout', 'SPLOADOPTIONS',
    'ISpObjectTokenCategory', 'SVP_14', 'SVEBookmark',
    'DISPID_SGRs_NewEnum', 'SAFTDefault', 'SRESoundEnd', 'SRAExport',
    'DISPID_SRGetPropertyString', 'SDA_Consume_Leading_Spaces',
    'eLEXTYPE_RESERVED6', 'SITooSlow', 'DISPID_SWFEChannels',
    'SPSModifier', 'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SASPause',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCERequestUI',
    'DISPID_SPRules_NewEnum', 'DISPID_SPIRetainedSizeBytes',
    'SVEVoiceChange', 'SREFalseRecognition',
    'Speech_StreamPos_RealTime', 'DISPID_SPIProperties', 'SVP_20',
    'SpeechDataKeyLocation', 'SpeechAudioFormatGUIDWave',
    'SECLowConfidence', 'SPRECOCONTEXTSTATUS', 'SAFT24kHz8BitMono',
    'SpeechRuleAttributes', 'SpPhoneticAlphabetConverter',
    'SPWORDTYPE', 'SDTAudio', 'SRTReSent', 'SPEI_START_INPUT_STREAM',
    'SPCS_DISABLED', 'eLEXTYPE_RESERVED7', 'ISpeechPhraseRule',
    'DISPID_SpeechRecoResult', 'ISpeechDataKey',
    'DISPID_SRCEventInterests', 'DISPID_SVSpeak', 'SAFT22kHz8BitMono',
    'ISpObjectToken', 'IInternetSecurityMgrSite',
    'SRSInactiveWithPurge', 'DISPID_SDKSetLongValue',
    'SpeechRecoEvents', 'SAFT44kHz8BitStereo', 'SAFT8kHz8BitStereo',
    'DISPID_SVSLastBookmarkId', 'SPRST_ACTIVE_ALWAYS', 'SWTAdded',
    'DISPID_SRCEInterference', 'DISPID_SOTId', 'DISPID_SVSVisemeId',
    ...
    'SSFMOpenForRead', 'DISPID_SGRSTsItem',
    'ISpeechLexiconPronunciations', 'DISPID_SPIAudioSizeBytes',
    'SPDKL_DefaultLocation', 'SPAR_Low', 'SPWF_SRENGINE',
    'DISPID_SRSClsidEngine', 'SPINTERFERENCE',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SGRSTransitions',
    'DISPID_SPISaveToMemory', 'ISpeechPhraseReplacement',
    'DISPID_SRStatus', 'DISPID_SGRSTsCount',
    'SpTextSelectionInformation', 'eLEXTYPE_PRIVATE20',
    'DISPID_SRRPhraseInfo', 'DISPID_SWFEBitsPerSample',
    'SpResourceManager', 'SAFTADPCM_22kHzStereo',
    'DISPID_SGRAttributes', 'SPGS_DISABLED', 'ISpDataKey', 'SVP_8',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGRules',
    'SpeechCategoryRecoProfiles', 'SGLexical', 'SRCS_Enabled',
    'SASStop', 'ISpRecoGrammar', 'DISPID_SRCCreateResultFromMemory',
    'SPSHORTCUTPAIR', 'SGRSTTWord', 'ISpeechPhraseInfoBuilder',
    'DISPID_SLGetPronunciations', 'DISPID_SRRTStreamTime',
    'ISpeechRecoResult', 'ISpeechRecoResultDispatch',
    'DISPID_SRSCurrentStreamNumber', 'SPSNoun',
    'DISPID_SGRSTPropertyName', 'SRESoundStart', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRCEAdaptation', 'DISPID_SRGCmdSetRuleState',
    'SPAS_CLOSED', 'ISpMMSysAudio', 'SpeechTokenKeyFiles',
    'SPRECOGNIZERSTATUS', 'DISPIDSPTSI_ActiveOffset', 'SVP_19',
    'SAFT48kHz8BitMono', 'eLEXTYPE_MORPHOLOGY', 'SAFT16kHz16BitMono',
    'DISPID_SpeechGrammarRuleState', 'SPTEXTSELECTIONINFO',
    'SAFTADPCM_8kHzMono', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechVoice', 'eLEXTYPE_PRIVATE6', 'SPWT_PRONUNCIATION',
    'ISpeechPhraseAlternates', 'SPEI_TTS_BOOKMARK',
    'SpeechAllElements', 'SpeechRecognizerState', 'SPRS_INACTIVE',
    'DISPID_SOTDisplayUI', 'SRTStandard',
    'DISPID_SPERetainedSizeBytes', 'SGSDisabled', 'SAFT12kHz8BitMono',
    'SPPS_Modifier', 'ISpeechXMLRecoResult', 'SPVPRI_NORMAL',
    'SDTLexicalForm', 'DISPID_SPCLangId', 'DISPID_SpeechFileStream',
    'DISPID_SpeechAudioStatus', 'DISPID_SPCPhoneToId',
    'SAFTGSM610_11kHzMono', 'DISPID_SPIElements',
    'DISPID_SPEAudioSizeTime', 'DISPID_SDKGetBinaryValue',
    'DISPID_SWFEExtraData', 'DISPID_SRCVoice', 'STSF_LocalAppData',
    'DISPID_SRState', 'SPINTERFERENCE_NONE', 'DISPID_SRRTLength',
    'SASClosed', 'SpeechCategoryVoices',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SABufferNotifySize', 'DISPID_SLPPhoneIds',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechLexicon',
    'DISPID_SLGetGenerationChange', 'SPGRAMMARWORDTYPE', 'IStream',
    'DISPID_SpeechGrammarRule', 'SRATopLevel', 'SLOStatic',
    'DISPID_SPIStartTime', 'DISPID_SVSInputWordPosition',
    ...
    'SPRECOSTATE', 'SpeechPartOfSpeech', 'SPRECORESULTTIMES',
    'SPFILEMODE', 'DISPID_SPRulesCount', 'DISPID_SRGDictationUnload',
    'DISPID_SGRName', 'SP_VISEME_11', 'SVEViseme', 'SREAdaptation',
    'SPEI_RECOGNITION', 'SPPS_RESERVED4', 'ISpeechVoice',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_4', 'UINT_PTR',
    'DISPID_SpeechPhoneConverter', 'ISpLexicon', 'SPAR_High',
    'SRAImport', 'ISpPhoneticAlphabetConverter', 'SpeechInterference',
    'SPCT_DICTATION', 'SPPS_LMA', 'SVP_7',
    'DISPID_SRSSupportedLanguages', 'SPAO_NONE', 'SPLO_STATIC',
    'SRERecognition', 'DISPID_SRProfile',
    'DISPID_SRSetPropertyNumber', 'SpeechTokenValueCLSID', 'SVP_6',
    'DISPID_SRCERecognitionForOtherContext', 'SAFTADPCM_22kHzMono',
    'Speech_Default_Weight', 'DISPID_SPEPronunciation', 'SPBO_PAUSE',
    'ISpPhrase', 'SECFIgnoreCase', 'DISPID_SDKDeleteValue',
    'SPPS_Function', 'SINoise', 'ISpeechPhraseInfo',
    'DISPID_SGRInitialState', 'DISPID_SpeechRecoContext',
    'DISPID_SpeechDataKey', 'DISPID_SPRs_NewEnum', 'SPRST_NUM_STATES',
    'DISPID_SASState', 'DISPID_SPACommit', 'SpMemoryStream',
    'SPSVerb', 'SPAS_RUN', 'DISPID_SOTCSetId', 'STSF_AppData',
    'DISPID_SGRAddResource', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVSInputSentenceLength', 'SpPhraseInfoBuilder',
    'WAVEFORMATEX', 'DISPID_SPEDisplayAttributes',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPIAudioSizeTime', 'SGLexicalNoSpecialChars',
    'SPAS_PAUSE', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRSetPropertyString', 'DISPID_SRCESoundStart',
    'DISPID_SpeechObjectTokens', 'DISPID_SpeechXMLRecoResult',
    'SPVPRI_OVER', 'SpShortcut', 'SAFTNoAssignedFormat',
    'DISPID_SABIEventBias', 'SPAUDIOOPTIONS', 'SpeechDiscardType',
    'ISpeechRecoResult2', 'SDTProperty', 'DISPID_SVSpeakStream',
    'SPRST_INACTIVE', 'SpeechAudioProperties', 'SGRSTTRule',
    'SREPrivate', 'ISpeechPhraseRules', 'ISpeechLexiconPronunciation',
    'SpeechRegistryUserRoot', 'DISPID_SVRate', 'SVEPrivate',
    'SGRSTTEpsilon', 'DISPID_SVSRunningState',
    'DISPID_SRCEEnginePrivate', 'eLEXTYPE_PRIVATE9',
    'DISPID_SAFGetWaveFormatEx', '_ISpeechRecoContextEvents',
    'SPPS_RESERVED1', 'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVVolume',
    'DISPID_SPRFirstElement', 'SPPARTOFSPEECH', 'SPSMF_UPS',
    'SP_VISEME_16', 'DISPID_SPIEngineId', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SVEventInterests', 'SP_VISEME_13', 'SpWaveFormatEx',
    'SGDSActiveUserDelimited', 'SDTRule',
    'DISPID_SRCEPropertyStringChange', 'ISpeechObjectToken',
    'SPINTERFERENCE_TOOSLOW', 'SPCONTEXTSTATE',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SVGetProfiles', 'SVF_None', 'SINone', 'STSF_FlagCreate',
    'SpInProcRecoContext', 'DISPID_SAEventHandle',
    'SPEI_VOICE_CHANGE', 'ISpeechAudioFormat', 'ISpStream',
    'SREPropertyStringChange', 'DISPID_SDKCreateKey',
    'ISpeechObjectTokens', 'DISPID_SVEWord', 'SpeechVoiceSpeakFlags',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'STCLocalServer',
    'DISPID_SLAddPronunciation', 'SPAR_Unknown', 'SECFNoSpecialChars',
    'SVP_2', 'SVSFParseAutodetect', 'SDTAlternates',
    'DISPID_SPAs_NewEnum', 'SDTAll', 'SpeechCategoryAudioOut',
    'SpMMAudioEnum', 'SPEI_SR_PRIVATE', 'DISPID_SRRGetXMLResult',
    'DISPID_SGRSAddSpecialTransition', 'SDA_Two_Trailing_Spaces',
    'ISpeechGrammarRuleState', 'SPBO_TIME_UNITS', 'DISPID_SAFGuid',
    'DISPID_SRGCommit', 'DISPID_SLWsItem',
    'DISPID_SPIGetDisplayAttributes', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SRSActiveAlways', 'SpeechAudioState', 'ISpeechLexiconWord',
    'SpeechAudioVolume', 'ISpStreamFormatConverter', 'SGRSTTWildcard',
    'SGRSTTTextBuffer', 'SPBOOKMARKOPTIONS', 'SpStream',
    'DISPID_SRGIsPronounceable', 'SGSEnabled', 'SPEI_MIN_SR',
    'DISPID_SPIRule', 'DISPID_SPPFirstElement', 'DISPID_SDKDeleteKey',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRCreateRecoContext',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechAudioFormatGUIDText',
    'DISPID_SRCEPhraseStart', 'DISPID_SRGDictationSetState',
    'tagSPPROPERTYINFO', 'DISPID_SPPParent',
    'DISPID_SPAStartElementInResult', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SPAsItem', 'DISPID_SpeechLexiconWord', 'SGDisplay',
    'SVEPhoneme', 'DISPID_SRSAudioStatus', 'STCInprocServer',
    'SSTTTextBuffer', 'SREPropertyNumChange', 'SPEI_END_SR_STREAM',
    'ISpeechRecognizerStatus', 'DISPID_SVEViseme', 'LONG_PTR',
    'SP_VISEME_12', 'SPCT_SUB_COMMAND', 'SAFTCCITT_ALaw_22kHzStereo',
    ...
    'SPSEMANTICERRORINFO', 'eLEXTYPE_USER',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpeechGrammarRuleStateTransition', 'SVEEndInputStream',
    'SGDSInactive', 'SREInterference', 'SVSFPurgeBeforeSpeak',
    'DISPID_SAFType', 'DISPID_SOTDataKey',
    'DISPID_SpeechPhraseBuilder', 'SpeechTokenKeyAttributes',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRGReset',
    '__MIDL_IWinTypes_0009', 'SpeechVisemeFeature', 'SP_VISEME_10',
    'SRSActive', 'SECFDefault', 'DISPID_SASFreeBufferSpace',
    'DISPID_SVGetAudioInputs', 'ISpRecoContext', 'SP_VISEME_15',
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechBaseStream',
    'DISPID_SpeechMemoryStream', 'SPFM_OPEN_READONLY',
    'DISPID_SPEEngineConfidence', 'ISpeechPhraseReplacements',
    'ISpEventSink', 'STCAll', 'SPPS_NotOverriden',
    'DISPID_SRDisplayUI', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SGRClear', 'DISPID_SPEsItem', 'SPINTERFERENCE_TOOFAST',
    'SpObjectToken', 'IEnumString', 'ISequentialStream',
    'ISpXMLRecoResult', 'DISPID_SVEPhoneme', 'DISPID_SMSALineId',
    'DISPID_SPRText', 'SPGS_EXCLUSIVE', 'SAFTExtendedAudioFormat',
    'DISPID_SPARecoResult', 'DISPID_SVEVoiceChange',
    'DISPID_SOTCDefault', 'SPRULE', 'SPINTERFERENCE_TOOQUIET',
    'SPSSuppressWord', 'SAFTADPCM_11kHzMono',
    'DISPID_SRCRetainedAudio', 'SRTEmulated', 'SPDKL_CurrentUser',
    'SAFT12kHz16BitMono', 'ISpeechGrammarRules', 'DISPID_SLPsCount',
    'SPSHT_Unknown', 'eLEXTYPE_PRIVATE2', 'SPWT_DISPLAY',
    'DISPID_SRIsShared', 'SpNullPhoneConverter', 'SVP_9',
    'SpeechGrammarTagDictation', 'DISPID_SBSFormat',
    'DISPID_SPRuleId', 'SP_VISEME_17', 'SLTUser', 'SSTTDictation',
    'SAFT22kHz16BitMono', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPEAudioSizeBytes', 'SREStreamEnd',
    'DISPID_SpeechPhraseElement', 'SPEI_RESERVED3',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SVSPhonemeId',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SDKSetBinaryValue',
    'SDTDisplayText', 'STCInprocHandler', 'SAFTGSM610_8kHzMono',
    'DISPID_SVIsUISupported', 'DISPID_SRCVoicePurgeEvent',
    'SITooQuiet', 'DISPID_SPERequiredConfidence',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVEStreamEnd',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpeechVoicePriority',
    'SP_VISEME_4', 'SRAONone', 'DISPID_SVSLastStreamNumberQueued',
    ...
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechAudioBufferInfo',
    'SPEI_START_SR_STREAM', 'SPVPRI_ALERT', 'SSFMCreate',
    'SGPronounciation', 'SPEI_RECO_OTHER_CONTEXT', 'SPEI_RESERVED5',
    'DISPID_SRGCmdLoadFromMemory', 'ISpeechFileStream',
    'SPSInterjection', 'SPPS_RESERVED3',
    'DISPID_SpeechPhraseReplacement', 'SPSERIALIZEDRESULT',
    'ISpNotifyTranslator', 'SRADynamic', 'SVSFUnusedFlags',
    'SpMMAudioOut', 'SpPhoneConverter', 'SAFT8kHz16BitMono',
    'ISpRecoCategory', 'ISpeechPhraseElements',
    'SAFT16kHz16BitStereo', 'DISPID_SOTCEnumerateTokens',
    'SpeechTokenKeyUI', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SGRSAddWordTransition', 'DISPID_SDKEnumValues',
    'DISPID_SVGetVoices', 'ISpObjectWithToken',
    'DISPID_SREmulateRecognition', 'ISpeechPhoneConverter',
    'DISPID_SGRId', 'DISPID_SPAPhraseInfo', 'SAFT16kHz8BitMono',
    'DISPID_SpeechPhraseInfo', 'DISPID_SLPPartOfSpeech', 'SPCT_SLEEP',
    'SAFTCCITT_uLaw_22kHzMono', 'SPVPRIORITY', 'SDKLLocalMachine',
    'SPPS_Unknown', 'SPEI_HYPOTHESIS', 'DISPID_SVResume',
    'SPINTERFERENCE_NOSIGNAL', 'SAFT24kHz16BitStereo',
    'DISPID_SVDisplayUI', 'SSSPTRelativeToEnd',
    'DISPID_SpeechPhraseReplacements', 'SpVoice',
    'SpeechSpecialTransitionType', 'SpeechStreamSeekPositionType',
    'DISPID_SOTGetDescription', 'ISpeechVoiceStatus',
    'DISPID_SVWaitUntilDone', 'SpLexicon', 'DISPID_SPPConfidence',
    'DISPID_SpeechPhraseProperty', 'DISPID_SDKOpenKey',
    'ISpeechPhraseProperty', '_SPAUDIOSTATE', 'ISpNotifySink',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SpeechLexiconProns',
    'DISPID_SPRuleFirstElement', 'DISPID_SOTRemove',
    'SpeechGrammarTagWildcard', 'SRAInterpreter', 'ISpeechRecognizer',
    'SPEI_RESERVED1', 'SPPS_Noun', 'SREAudioLevel',
    'DISPID_SRRTTickCount', 'DISPID_SRCPause', 'SPEI_PHONEME',
    'SpeechRegistryLocalMachineRoot', 'SAFT48kHz16BitStereo',
    'SRERequestUI', 'DISPID_SVStatus',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpResourceManager',
    'DISPID_SVEAudioLevel', 'DISPID_SGRSRule', 'SPVOICESTATUS',
    'SBONone', 'DISPID_SVPriority', 'DISPID_SPRuleChildren',
    'DISPID_SRRAudio', 'SAFT48kHz8BitStereo', 'SpeechRuleState',
    'SPCT_COMMAND', 'ISpEventSource', 'DISPID_SLWLangId',
    'SVF_Emphasis', 'DISPID_SMSADeviceId', 'DISPID_SGRsAdd',
    'SREHypothesis', 'ISpProperties', 'ISpeechMMSysAudio',
    'SAFT16kHz8BitStereo', 'SAFTCCITT_uLaw_44kHzStereo', 'SINoSignal',
    'SVP_1', 'DISPID_SRCEAudioLevel', 'SVSFNLPSpeakPunc',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFT12kHz16BitStereo',
    'DISPID_SPPName', 'eLEXTYPE_PRIVATE8', 'SRTSMLTimeout'
]
